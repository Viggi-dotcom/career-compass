const CAREERS = {
  eng: {
    ...
    details: {
      ...
      branches: "⚙️ Popular Branches:\n• Computer Science\n• Mechanical Engineering\n• Electrical Engineering\n• Civil Engineering\n• Electronics & Communication",
      entrance: "📚 Major Exams:\n• JEE Main & Advanced\n• State CET\n• BITSAT\n• VITEEE",
      careers: "💼 Career Options:\n• Software Engineer (₹4-40 LPA)\n• Civil Engineer (₹3-25 LPA)\n• Mechanical Engineer\n• Electronics Engineer",
      skills: "🛠️ Required Skills:\n• Strong Mathematics\n• Problem Solving\n• Technical Drawing\n• Software Tools\n• Project Management"
    }
  },
  ai: {
    title: "AI & Robotics",
  ...
  psych: {
    ...
    details: {
      ...
      careers: "💼 Career Paths:\n• Clinical Psychologist (₹4-15 LPA)\n• Counselor\n• Social Worker\n• Research Psychologist",
  ...
  it: {
    ...
    desc: "Shape the digital future through code! From AI and machine learning to cybersecurity. Starting salary: ₹4-8 LPA. High growth potential worldwide.",
    img: "https://images.unsplash.com/photo-1571171637578-41bc2dd41cd2?auto=format&fit=crop&w=1400&q=80",
    details: {
      courses: "🎓 Popular Courses:\n• B.Tech in Computer Science (4 years)\n• BCA - Bachelor in Computer Applications (3 years)\n• Diploma in IT (2-3 years)\n• Specialized Bootcamps (3-6 months)",
      skills: "💡 Key Skills:\n• Programming (Python, Java, JavaScript)\n• Problem Solving & Algorithms\n• Cloud Computing\n• DevOps & CI/CD\n• Cybersecurity Basics",
      careers: "💼 Career Paths:\n• Software Developer (₹5-25 LPA)\n• Data Scientist (₹8-30 LPA)\n• Cloud Architect (₹12-40 LPA)\n• DevOps Engineer (₹8-35 LPA)",
  ...
  health: {
    ...
    details: {
      ...
      entrance: "📚 Entrance Exams:\n• NEET-UG (National Level)\n• AIIMS Entrance\n• JIPMER\n• State Medical Tests",
      careers: "💉 Specializations:\n• General Medicine (₹8-15 LPA)\n• Surgery (₹10-30 LPA)\n• Pediatrics\n• Cardiology\n• Neurology",
  ...
  design: {
    ...
    details: {
      courses: "🎨 Design Programs:\n• B.Des - Design (4 years)\n• Animation & VFX (3-4 years)\n• UI/UX Design (1-2 years)\n• Graphic Design Diploma",
      tools: "🛠️ Essential Tools:\n• Adobe Creative Suite\n• Figma/Sketch\n• Blender\n• Cinema 4D\n• After Effects",
